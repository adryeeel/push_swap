...
bool ft_exec_optim_ra_rb(size_t sa_idx, size_t sb_idx, t_stack *sa, t_stack *sb)
{
	size_t max;
	size_t rra_ops;
...
bool ft_exec_optim_rrr_rra(size_t sa_idx, size_t sb_idx, t_stack *sa, t_stack *sb)
{
	size_t rra_ops;
