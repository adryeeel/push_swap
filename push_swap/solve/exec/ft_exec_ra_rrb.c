...
bool ft_exec_optim_rra_rrb(size_t sa_idx, size_t sb_idx, t_stack *sa, t_stack *sb)
{
    size_t max;
    size_t rb_ops;
    size_t ra_ops;
...
bool ft_exec_optim_rrr_rrb(size_t sa_idx, size_t sb_idx, t_stack *sa, t_stack *sb)
{
    size_t rrb_ops;
