...
void		ft_exec_ra_rb(size_t sa_idx, size_t sb_idx, t_stack *sa,
				t_stack *sb);
void		ft_exec_ra_rrb(size_t sa_idx, size_t sb_idx, t_stack *sa,
				t_stack *sb);
void		ft_exec_rra_rb(size_t sa_idx, size_t sb_idx, t_stack *sa,
				t_stack *sb);
void		ft_exec_rra_rrb(size_t sa_idx, size_t sb_idx, t_stack *sa,
				t_stack *sb);
